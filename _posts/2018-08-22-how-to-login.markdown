...
img: howtouse.PNG # Add image post (optional)
...
회사의 메일계정을 안내하고, 로그인방법을 안내해주세요.

>최초 로그인시 암호는 설정되지 않았으므로, 로그인 화면에서 비밀번호 찾기로 자신의 메일계정으로 임시 비밀번호를 받습니다. 로그인후 프로필관리에서 임시암호를 자신이 사용할 암호로 변경하여 사용합니다.
